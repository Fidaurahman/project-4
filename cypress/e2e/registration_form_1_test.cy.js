...
describe('This is first test suite,Fida ur Rahman', () => {
    it('User can submit data only when valid mandatory values are added', () => {
        // 28th september 2024
        cy.get('#username').type('faykhan')
        cy.get('[data-testid="phoneNumberTestId"]').type('555666777')
        cy.get('input[name="password"]').type('F1d4@1234')
        cy.get('[name="confirm"]').type('F1d4@1234')
